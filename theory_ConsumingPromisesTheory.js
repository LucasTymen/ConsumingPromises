...
that it will settle. How do we tell the computer what should happen then?
Promise objects come with an aptly named .then() method. It allows us to say,
...
In the case of our dishwasher promise, the dishwasher will run then:
    ...
    If our promise rejects, this means we have dirty dishes, and we’ll add soap
...
arguments. We refer to these callbacks as handlers. When the promise settles,
...
handler is not provided, instead of throwing an error, .then() will just return
a promise with the same settled value as the promise it was called on.
